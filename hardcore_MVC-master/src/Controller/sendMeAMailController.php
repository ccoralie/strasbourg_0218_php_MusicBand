...
class sendMeAMailController extends AbstractController
{
    protected $errors = [];
    ...
    public function envoiMeMail()
    {
        ...
        if (isset($_POST['submit']) && !empty($_POST['TEXT']))  {
            try {
                ...
                $mail->addAddress('kylebrace1@gmail.com', 'Kyle Brace');// Add a recipient
                $mail->Subject = 'I Need An Album Display';
